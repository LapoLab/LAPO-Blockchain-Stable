...
RESOURCES += src/qt/lapo.qrc src/qt/lapo_locale.qrc

TRANSLATIONS += src/qt/locale/lapo_bg.ts \
                src/qt/locale/lapo_de.ts \
                src/qt/locale/lapo_en.ts \
                src/qt/locale/lapo_es.ts \
                src/qt/locale/lapo_fi.ts \
                src/qt/locale/lapo_fr.ts \
                src/qt/locale/lapo_it.ts \
                src/qt/locale/lapo_ja.ts \
                src/qt/locale/lapo_pl.ts \
                src/qt/locale/lapo_pt.ts \
                src/qt/locale/lapo_ru.ts \
                src/qt/locale/lapo_sk.ts \
                src/qt/locale/lapo_sv.ts \
                src/qt/locale/lapo_vi.ts \
                src/qt/locale/lapo_zh_CN.ts \
                src/qt/locale/lapo_zh_TW.ts
