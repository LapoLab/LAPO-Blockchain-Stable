...
#   c) node1 mines 32 blocks, so now node 0 has 60001lax, node 1 has 4250lax, node2 has none.
#   d) node0 sends 601 lax to node2, in two transactions (301 lax, then 300 lax).
