...
In order to support loading of multiple wallets in lapo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lapo.cpp.
...
Changes to lapo.cpp
----------------------
lapo.cpp is the entry point into lapo-qt, and as such, will require some minor modifications to provide hooks for
