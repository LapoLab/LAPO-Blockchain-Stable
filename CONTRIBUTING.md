Contributing to LAPO Core
============================

The LAPO Core project operates an open contributor model where anyone is
...
The following applies to code changes to the LAPO Core project, and is not to be
confused with overall LAPO Network Protocol consensus changes.

Whether a pull request is merged into LAPO Core rests with the project merge
...
Patches that change LAPO consensus rules are considerably more involved than
...
Where a patch set proposes to change the LAPO consensus, it must have been
...
The project leader is the release manager for each LAPO Core release.
