...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* LAPO features */
        {"lapo", "masternode", &masternode, true, true, false},
        {"lapo", "listmasternodes", &listmasternodes, true, true, false},
        {"lapo", "getmasternodecount", &getmasternodecount, true, true, false},
        {"lapo", "masternodeconnect", &masternodeconnect, true, true, false},
        {"lapo", "masternodecurrent", &masternodecurrent, true, true, false},
        {"lapo", "masternodedebug", &masternodedebug, true, true, false},
        {"lapo", "startmasternode", &startmasternode, true, true, false},
        {"lapo", "createmasternodekey", &createmasternodekey, true, true, false},
        {"lapo", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"lapo", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"lapo", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"lapo", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"lapo", "getmasternodescores", &getmasternodescores, true, true, false},
        {"lapo", "mnbudget", &mnbudget, true, true, false},
        {"lapo", "preparebudget", &preparebudget, true, true, false},
        {"lapo", "submitbudget", &submitbudget, true, true, false},
        {"lapo", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"lapo", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"lapo", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"lapo", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"lapo", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"lapo", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"lapo", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"lapo", "checkbudgets", &checkbudgets, true, true, false},
        {"lapo", "mnsync", &mnsync, true, true, false},
        {"lapo", "spork", &spork, true, true, false},
        {"lapo", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"lapo", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> lapo-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:31718/\n";
}
