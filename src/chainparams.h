...
// Copyright (c) 2018 The LAPO Core developers
 ...
 * LAPO system. There are three: the main network on which people trade goods
...
public:
    ...
    int SubsidyBudgetPercentage() const { return nSubsidyBudgetPercentage; }
    ...
    int AvailableThreads() const { return nAvailableThreads; }
    ...
    CAmount LPCtxMinFee() const { return nLPCtxMinFee; }
    CAmount MinTxFeePerK() const { return nMinTxFeePerK; }
    CAmount MinRelayTxFeePerK() const { return nMinRelayTxFeePerK; }
...
protected:
    ...
    int nSubsidyBudgetPercentage;       // e.g., 10
    ...
    CAmount nLPCtxMinFee;
    CAmount nMinTxFeePerK;
    CAmount nMinRelayTxFeePerK;
        
    int nMinerThreads;
    int nAvailableThreads;
