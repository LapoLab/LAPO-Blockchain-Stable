...
public:
    ...
    QSize minimumSizeHint() const
    {
        if (cachedMinimumSizeHint.isEmpty()) {
            ...
            int w = fm.width(BitcoinUnits::format(BitcoinUnits::LAX, BitcoinUnits::maxMoney(), false, BitcoinUnits::separatorAlways));
                                                          ...
                                                          amount(0)
{
    ...
    unit->setEnabled(false); // temporarily
