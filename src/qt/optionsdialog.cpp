...
//    printf("is it a new dialog - nMiningThreads=%d\n", nMiningThreads);

    /* Mining threads */
    ui->sliderMiningThreads->setMinimum(0);
    ui->sliderMiningThreads->setMaximum(Params().AvailableThreads());
...
/* Window elements init */
    ...
    ui->unit->setEnabled(false); // temporarily
...
void OptionsDialog::setModel(OptionsModel* model)
{
    ...
    connect(ui->sliderMiningThreads, SIGNAL(valueChanged(int)), this, SLOT(setGenerate()));

    ui->sliderMiningThreads->setValue(nMiningThreads);
}

void OptionsDialog::setGenerate()
{
    nMiningThreads = ui->sliderMiningThreads->value();
    this->model->setGenerate(nMiningThreads);
}
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->sliderMiningThreads, OptionsModel::MiningThreads);
}
