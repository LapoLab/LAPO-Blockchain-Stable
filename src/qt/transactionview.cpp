 ...
 */
    ...
    typeWidget->addItem(tr("Received Lax from zLax"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zLax"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zLax));
