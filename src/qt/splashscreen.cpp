...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("LAPO Core");
    ...
    // QString copyrightTextLAPO = QChar(0xA9) + QString(" 2018 ") + QString(tr("The LAPO Core developers"));
    ...
    // pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextLAPO);
