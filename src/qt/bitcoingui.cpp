                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("LAPO Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LAPO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lapo: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zLAX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About LAPO Core"), this);
    aboutAction->setStatusTip(tr("Show information about LAPO Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LAPO"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LAPO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LAPO addresses"));
    ...
    openAction->setStatusTip(tr("Open a LAPO: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the LAPO Core help message to get a list with possible LAPO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("LAPO Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LAPO network", "", count));
}
...
{
    QString strTitle = tr("LAPO Core"); // default title
