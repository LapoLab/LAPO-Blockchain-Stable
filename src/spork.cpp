...
// LAPO: on startup load spork values from previous session if they exist in the sporkDB
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_2_LPCTX) r = SPORK_2_LPCTX_DEFAULT;
        if (nSporkID == SPORK_3_LPCTX_BLOCK_FILTERING) r = SPORK_3_LPCTX_BLOCK_FILTERING_DEFAULT;
        ...
        if (nSporkID == SPORK_17_NEW_PROTOCOL_TARGETTIME) r = SPORK_17_NEW_PROTOCOL_TARGETTIME_DEFAULT;
...
{
    if (strName == "SPORK_2_LPCTX") return SPORK_2_LPCTX;
    if (strName == "SPORK_3_LPCTX_BLOCK_FILTERING") return SPORK_3_LPCTX_BLOCK_FILTERING;
    ...
    if (strName == "SPORK_17_NEW_PROTOCOL_TARGETTIME") return SPORK_17_NEW_PROTOCOL_TARGETTIME;
...
{
    if (id == SPORK_2_LPCTX) return "SPORK_2_LPCTX";
    if (id == SPORK_3_LPCTX_BLOCK_FILTERING) return "SPORK_3_LPCTX_BLOCK_FILTERING";
    ...
    if (id == SPORK_17_NEW_PROTOCOL_TARGETTIME) return "SPORK_17_NEW_PROTOCOL_TARGETTIME";
